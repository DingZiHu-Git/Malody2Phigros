...
public class FaqFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		group2.put("group1", getString(R.string.fragment_faq_how_to_make_a_plugin_title));
		groups.add(group2);
		List<Map<String, Object>> child2 = new ArrayList<>();
		Map<String, Object> child2I = new HashMap<>();
		child2I.put("child1", getString(R.string.fragment_faq_how_to_make_a_plugin_content));
		child2.add(child2I);
		childs.add(child2);
